...
foreach ($todosPokemon as $row) {
    ...
    switch ($row['ntpoke']) {
        case "Agua":   $fondoTipo = "shadow bg-light border-5 border-primary text-dark"; break;
        case "Fuego":  $fondoTipo = "shadow bg-light border-5 border-danger text-dark";  break;
        case "Planta": $fondoTipo = "shadow bg-light border-5 border-success text-dark"; break;
        default:       $fondoTipo = "bg-light border-5 border-secondary text-dark";
    }
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button id="btnReintentar" class="btn btn-secondary btn-lg px-4 d-none" onclick="reiniciarBatalla()">
                    🔄 Volver a elegir
                </button>
            </div>
